...
const scrollItems = [
  ...
  { content: <p>Late-night coding sessions are often powered by coffee and Dark Souls marathons.</p> },
  ...
  { content: "When not coding, you’ll find me conquering bosses or exploring open-world games</p>" },
  ...
  return (
    <div>
      ...
      <main className="container">
        ...
        <h1>languages i am comfortable with</h1>
        <div style={{ height: '300px', position: 'static' }}>
