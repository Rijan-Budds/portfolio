...
type InfiniteScrollItem = { content: React.ReactNode };
...
export default function InfiniteScroll({
  ...
  type ObserverEvent = { target: Element };

  const observer = Observer.create({
      target: container,
      type: 'wheel,touch,pointer',
      preventDefault: true,
      onPress: ({ target }: ObserverEvent) => {
        (target as HTMLElement).style.cursor = 'grabbing';
      },
      onRelease: ({ target }: ObserverEvent) => {
